...
if(isset($_POST['update'])){
    ...
    $sql = "update person_details set firstname='$firstname', lastname='$lastname', email='$email', password='$password', gender='$gender', native='$native', skills='$skills',image='$escapedImage', location='$location' where id='$id'";
