    ...
    if($total==0)
{
  ...
  //  $image = file_get_contents($_FILES['uploadfile']['tmp_name']);
   ...
   $sql = "insert into person_details(id,firstname,lastname,email,password,gender,native,skills,country,state,city,role,location) values('$id','$firstname','$lastname','$email','$hashedPassword','$gender','$native','$skills1','$country','$state','$city','$role','$location')";
